...
export type MetapouchToggleTheme = {
...
export interface MetapouchToggleProps extends InputHTMLAttributes<HTMLInputElement> {
  scale?: Scales;
  checked?: boolean;
}
...
export const scaleKeys = {
  metapouchSize: 'metapouchSize',
  travelDistance: 'travelDistance',
  toggleHeight: 'toggleHeight',
  toggleWidth: 'toggleWidth',
  metapouchThickness: 'metapouchThickness',
  metapouchTwoOffset: 'metapouchTwoOffset',
  metapouchThreeOffset: 'metapouchThreeOffset',
  butterTop: 'butterTop',
