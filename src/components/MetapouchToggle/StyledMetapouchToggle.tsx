...
const scaleKeyValues = {
  sm: {
    metaPouchSize: '14px', // The size of a pancake (the handle)
    ...
    metapouchThickness: '1px', // Bottom shadow of a pancake
    metapouchTwoOffset: '0px', // Pancakes don't look good when they are concentric
    metapouchThreeOffset: '-3px', // so pancake 2 and 3 are shifted a little bit
